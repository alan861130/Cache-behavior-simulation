...
configPool="cacheA cacheB cacheC cacheD cacheE cacheG cacheH cacheI"
benchPool="DataReference_n_comp DataReference_n_real InstReference_iir_one InstReference_lms"
timeLimit=60
...
if [[ $fail_flag == "1" ]]; then
    printf "Something's wrong i can feel it. -- Eminem \n"
